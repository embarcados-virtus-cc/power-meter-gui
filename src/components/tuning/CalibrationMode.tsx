      ...
      <div className="space-y-6">
        <div className="text-center md:text-left">
          ...
          <div className="bg-zinc-800/30 border border-zinc-800 p-6 rounded-xl text-sm text-slate-400 leading-relaxed">
            Utiliza os valores de calibração internos armazenados na EEPROM do
            módulo SFP+. Os dados são calculados automaticamente pelo firmware
            do transceptor.
          </div>
        </div>
        ...
        <div className="text-center md:text-left">
          ...
          <div className="bg-zinc-800/30 border border-zinc-800 p-6 rounded-xl text-sm text-slate-400 leading-relaxed">
            Permite aplicar coeficientes de calibração externos. Útil para
            compensar desvios ou calibrar contra um padrão de referência.
          </div>
        </div>
      </div>
    </div>
