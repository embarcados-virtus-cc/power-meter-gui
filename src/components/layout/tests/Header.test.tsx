...
describe('Header', () => {
    it('renders loading skeleton initially', () => {
        ...
        // Check for skeleton elements by class or structure, here just ensuring it renders without crashing
        // The skeleton has specific classes, but we can check if eventually it shows content
    })
    ...
    it('renders logo after loading', async () => {
        ...
        await waitFor(() => {
            expect(screen.getByText(/MEDIDOR DE POTÊNCIA ÓPTICA/i)).toBeInTheDocument()
        })
    })
